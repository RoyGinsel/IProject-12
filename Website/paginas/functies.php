...
{
  	return preparedQuery("SELECT looptijdBeginDag, looptijdEindeDag,looptijd,titel,voorwerpNummer,plaatsnaam,land,betaalWijze,betalingsInstructie,startPrijs,verzendkosten,verkoper,beschrijving
				from tblVoorwerp
